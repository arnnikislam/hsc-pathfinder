...
// Replace with real developer photo URL after upload
const DEV_PHOTO = null // e.g. 'https://firebasestorage.googleapis.com/...'
      ...
      <div className="page-container pt-6">
        ...
        <div className="relative overflow-hidden card mb-4">
          ...
          <div className="relative flex items-center gap-4 mb-4">
            ...
            <div className="relative flex-shrink-0">
              {DEV_PHOTO ? (
                <img src={DEV_PHOTO} alt="Arnnik Islam Payel" className="w-20 h-20 rounded-2xl object-cover border-2 border-brand-500/40" />
              ) : (
                <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-brand-500 to-accent-500 flex items-center justify-center text-3xl font-display font-bold text-white">
                  A
                </div>
              )}
              <div className="absolute -bottom-1 -right-1 w-6 h-6 bg-green-500 rounded-full border-2 border-surface-800 flex items-center justify-center">
        ...
        <div className="card mb-4">
          ...
          <div className="space-y-2 text-xs text-white/50 font-body leading-relaxed">
            <p>🎓 Built specifically for <span className="text-white/80">HSC 2026</span> candidates in Bangladesh</p>
